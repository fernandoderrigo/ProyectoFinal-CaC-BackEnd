...
const cargarProductos = async (rutaJson, tipoProducto) => {
  try {
    ...
    data[tipoProducto.toLowerCase()].forEach((element) => {
      ...
      imagenCarrito.src =
        "static/assets/Productos/MaterialSymbolsAddShoppingCart.png";
...
cargarProductos("static/assets/Productos/bombones.json", "Bombones");
cargarProductos("static/assets/Productos/cajitas.json", "Cajitas");
cargarProductos("static/assets/Productos/figurasDeAzucar.json", "Figuras-Azucar");
cargarProductos(
  "static/assets/Productos/figurasChocolate.json",
  "Figuras_chocolate"
);
cargarProductos("static/assets/Productos/flores.json", "Flores");
cargarProductos("static/assets/Productos/huevos.json", "Huevos");
cargarProductos("static/assets/Productos/mensajes.json", "Mensajes");
cargarProductos("static/assets/Productos/ositos.json", "Ositos");
cargarProductos("static/assets/Productos/paletitas.json", "Paletitas");
